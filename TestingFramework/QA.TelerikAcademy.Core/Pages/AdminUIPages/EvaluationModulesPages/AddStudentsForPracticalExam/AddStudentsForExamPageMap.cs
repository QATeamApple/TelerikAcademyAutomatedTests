namespace QA.TelerikAcademy.Core.Pages.AdminUIPages.EvaluationModulesPages.AddStudentsForPracticalExam
{
    using ArtOfTest.WebAii.Controls.HtmlControls;
    using ArtOfTest.WebAii.Core;
    using QA.UI.TestingFramework.Core;

    public class AddStudentsForExamPageMap : BaseElementMap
    {
        public HtmlSpan Exam
        {
            get
            {
                return this.Find.ByContent<HtmlSpan>("Изберете практически изпит");
            }
        }
